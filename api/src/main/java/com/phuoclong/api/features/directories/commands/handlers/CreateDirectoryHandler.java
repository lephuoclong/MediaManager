...
public class CreateDirectoryHandler implements Command.Handler<CreateDirectory, ResponseMessageOf<String>> {
    ...
    public ResponseMessageOf<String> handle(CreateDirectory command) {
        ...
        if(parentDirectory.isEmpty()){
            return ResponseMessageOf.ofBadRequest(ResponseConstant.NOTFOUND_PARENT_DIRECTORY,
                    Map.of(CreateDirectory.Fields.parentId, ResponseConstant.NOTFOUND_PARENT_DIRECTORY));
        }
        ...
        if (Boolean.TRUE.equals(existsDirectoryName)){
            ...
            return ResponseMessageOf.ofBadRequest(ResponseConstant.EXISTS_DIRECTORY,
                    Map.of(CreateDirectory.Fields.name, ResponseConstant.EXISTS_DIRECTORY));
