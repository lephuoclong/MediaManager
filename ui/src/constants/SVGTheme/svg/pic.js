...
const pic = (
  <svg
    ...
    <path
      style={{ fill: "#6DABE4" }}
      d='M462.099,512H49.902c-9.932,0-17.984-8.052-17.984-17.984V17.984C31.918,8.052,39.97,0,49.902,0
    ...
    <path
      ...
      d='M79.733,485.241c-9.932,0-17.984-8.051-17.984-17.983V0H49.902
    ...
    <path
      style={{ fill: "#FFFFFF" }}
      d='M408.446,383.407H103.555c-3.8,0-6.879-3.08-6.879-6.879V71.637c0-3.8,3.08-6.879,6.879-6.879
    ...
    <path
      style={{ fill: "#4C9462" }}
      d='M275.075,275.262c-11.102,0-21.638,2.389-31.154,6.649c-13.767-13.475-32.602-21.792-53.386-21.792
    ...
    <path
      style={{ fill: "#8D6645" }}
      d='M355.929,149.631c-7.662-13.271-26.817-13.271-34.479,0L186.48,383.407h221.965
	c3.8,0,6.879-3.08,6.879-6.879v-124.02L355.929,149.631z'
    />
    <path
      style={{ fill: "#99DAEA" }}
      d='M355.929,149.631c-7.662-13.271-26.817-13.271-34.479,0l-42.418,73.471
    ...
    <polygon
      ...
      points='186.48,383.407 225.544,383.407 315.328,160.236 '
    />
  </svg>
);
export default pic;
